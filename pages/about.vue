    ...
    <div class="flex justify-center flex-col">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-12 gap-10 justify-items-center mt-6 md:px-64 py-10">
                ...
                <div class="flex flex-col items-center">
                    <img src="@/assets/images/team/rida.jpeg" alt="Avatar 3" class="rounded-full w-24 h-24 object-cover">
                    <p class="mt-2 text-lg font-semibold">Rida Ashraf</p>
                    <a href="https://www.behance.net/ridaashraf1" target="_blank" class="flex inline text-gray-600 pt-2">
