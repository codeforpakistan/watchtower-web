<template>
  ...
  <div v-if="!showSkeleton" class="flex items-end justify-center gap-5 mb-10 mt-10">
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <div
            class="flex flex-col justify-end items-center w-32 h-44 bg-gradient-to-br from-gray-400 to-gray-300 rounded-t-lg shadow-md relative hover:shadow-lg hover:scale-105 transition-transform duration-200">
            <div
      ...
      <Tooltip>
        <TooltipTrigger>
          <div
            class="flex flex-col justify-end items-center w-32 h-56 bg-gradient-to-br from-yellow-400 to-yellow-300 rounded-t-lg shadow-md relative hover:shadow-lg hover:scale-105 transition-transform duration-200">
            <div
  ...
  <div v-if="showSkeleton" class="flex flex-col items-center space-y-4 mt-8">
